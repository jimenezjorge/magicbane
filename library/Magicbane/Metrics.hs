...
-- JJ import qualified System.Remote.Monitoring.Wai
-- JJ import           System.Remote.Monitoring.Wai as X (serverMetricStore)
import           Network.Wai.Metrics as X
import           Data.ByteString (ByteString)

newtype ModMetrics = ModMetrics Metrics

-- JJ forkMetricsServer ∷ ByteString → Int → IO System.Remote.Monitoring.Wai.Server
-- JJ forkMetricsServer = System.Remote.Monitoring.Wai.forkServer
